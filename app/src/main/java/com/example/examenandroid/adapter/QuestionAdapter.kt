...
class QuestionAdapter(context: FragmentActivity?, private val qcmArray: ArrayList<QuestionReponse>, private val reponses: HashMap<Int, String>, private val afficherResultat: Boolean, afficherScore: IAfficheScore) : RecyclerView.Adapter<QuestionAdapter.ViewHolder>() {
    var score = 0
